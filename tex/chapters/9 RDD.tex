...
Model składa się z węzłów i gałęzi. Każdy węzeł wewnętrzny reprezentuje cechę (lub atrybut), każda gałąź reprezentuje regułę decyzyjną, a każdy węzeł liścia reprezentuje przewidywany wynik (wartość zmiennej docelowej). Ogólna budowa przypomina strukturę drzewa.
